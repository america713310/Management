...
namespace SapsanApp.Controllers.v1._0
{
    ...
    public class LanguagesController : ControllerBase
    {
        ...
        private IGenericRepository<Language, int> _rep;
        public LanguagesController(
            IGenericRepository<Language, int> rep,
        ...
        public async Task<IActionResult> Get()
        {
            try
            {
                _context.Logs.Add(new Log()
                {
                    ...
                    Description = $"Getting a list of languages by {User.Identity.Name}",
                    Type = "Get"
                });
        ...
        public async Task<IActionResult> GetById(int id)
        {
            ...
            try
            {
                ...
                {
                    UserId = _context.Users.AsNoTracking().FirstOrDefault(x => x.Email == User.Identity.Name).Id,
                    Description = $"Getting a language data by ID by {User.Identity.Name}",
                    Type = "Get"
                });
        ...
        public async Task<IActionResult> Post([FromBody] Language model)
        {
            ...
            try
            {
                ...
                {
                    UserId = _context.Users.AsNoTracking().FirstOrDefault(x => x.Email == User.Identity.Name).Id,
                    Description = $"Posted a languages data by {User.Identity.Name}",
                    Type = "Post"
                });
        ...
        [EnableCors]
        [HttpPut]
        public async Task<IActionResult> Put([FromBody] Language model)
        {
            if (model == null)
                return BadRequest(new { errorText = "Invalid input data!" });
            ...
            try
            {
                ...
                {
                    UserId = _context.Users.AsNoTracking().FirstOrDefault(x => x.Email == User.Identity.Name).Id,
                    Description = $"Edited a languages data by {User.Identity.Name}",
                    Type = "Put"
                });
        ...
        public async Task<IActionResult> Delete(int id)
        {
            ...
            try
            {
                ...
                {
                    UserId = _context.Users.AsNoTracking().FirstOrDefault(x => x.Email == User.Identity.Name).Id,
                    Description = $"Removed a languages data by {User.Identity.Name}",
                    Type = "Delete"
                });
