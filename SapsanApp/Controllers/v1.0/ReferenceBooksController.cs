...
namespace SapsanApp.Controllers.v1._0
{
    ...
    public class ReferenceBooksController : ControllerBase
    {
        ...
        private IGenericRepository<ReferenceBook, int> _rep;
        public ReferenceBooksController(
            IGenericRepository<ReferenceBook, int> rep,
        ...
        public async Task<IActionResult> Get()
        {
            try
            {
                _context.Logs.Add(new Log()
                {
                    ...
                    Description = $"Getting a list of reference books by {User.Identity.Name}",
                    Type = "Get"
                });
        ...
        {
            if (_context.ReferenceBooks.FirstOrDefault(x => x.Id == id) == null)
                return NotFound();
            ...
            try
            {
                ...
                {
                    UserId = _context.Users.AsNoTracking().FirstOrDefault(x => x.Email == User.Identity.Name).Id,
                    Description = $"Getting a reference book by ID by {User.Identity.Name}",
                    Type = "Get"
                });
        ...
        [EnableCors]
        [HttpPost]
        public async Task<IActionResult> Post([FromBody] ReferenceBook model)
        {
            if (model == null)
            ...
            try
            {
                ...
                {
                    UserId = _context.Users.AsNoTracking().FirstOrDefault(x => x.Email == User.Identity.Name).Id,
                    Description = $"Posted a reference book by {User.Identity.Name}",
                    Type = "Post"
                });
        ...
        [EnableCors]
        [HttpPut]
        public async Task<IActionResult> Put([FromBody] ReferenceBook model)
        {
            if (model == null)
                return BadRequest(new { errorText = "Invalid input data!" });
            ...
            try
            {
                ...
                {
                    UserId = _context.Users.AsNoTracking().FirstOrDefault(x => x.Email == User.Identity.Name).Id,
                    Description = $"Edited a reference book by {User.Identity.Name}",
                    Type = "Put"
                });
        ...
        public async Task<IActionResult> Delete(int id)
        {
            ...
            try
            {
                ...
                {
                    UserId = _context.Users.AsNoTracking().FirstOrDefault(x => x.Email == User.Identity.Name).Id,
                    Description = $"Removed a reference book by {User.Identity.Name}",
                    Type = "Delete"
                });
